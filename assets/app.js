...
const attendanceStorageKey = "ps_escola_atendimentos";
const workflowStorageKey = "ps_escola_triagem_workflow";
...
class TriageApp {
  constructor() {
    this.state = new AppState(patientStorageKey, triageStorageKey, attendanceStorageKey, workflowStorageKey);
  ...
  createDomMap() {
    return {
      ...
      confirmRiskSuggestion: document.getElementById("confirmRiskSuggestion"),
      riskSuggestion: document.getElementById("riskSuggestion"),
      queueBoard: document.getElementById("queueBoard"),
      toggleAttendance: document.getElementById("toggleAttendance"),
